...
namespace Synthbot.WebApp.Migrations
{
    ...
    [Migration("20180919223839_playback-sessions")]
    partial class playbacksessions
    {
            ...
            modelBuilder.Entity("Synthbot.WebApp.Models.PlaybackSession", b =>
                {
                    ...
                    b.HasIndex("PlaylistOwnerId")
                        .IsUnique()
                        .HasFilter("[PlaylistOwnerId] IS NOT NULL");
            ...
            modelBuilder.Entity("Synthbot.WebApp.Models.PlaybackSession", b =>
                {
                    ...
                    b.HasOne("Synthbot.WebApp.Models.SynthbotUser", "PlaylistOwner")
                        .WithOne("OwnedPlaybackSession")
                        .HasForeignKey("Synthbot.WebApp.Models.PlaybackSession", "PlaylistOwnerId");
                });
