...
namespace Synthbot.DiscordBot.Services
{
	...
	{
		// TODO: Do these need to be passed into the constructor if we're just adding to the log?
		...
		public DiscordLogService(DiscordSocketClient discord, CommandService commands, ILoggerFactory loggerFactory)
		{
			_discord = discord;
			_commands = commands;
